		...
		<div className="relative z-20 -mt-14 flex items-center flex-col justify-center w-[100%] h-screen overflow-hidden">
			<div className="relative w-[80%] h-screen flex flex-col items-center justify-center mx-20">
				<h1
					className={`${
						qw.className
					} ${`z-10 text-center text-5xl border-collapse text-[#E7C494]`}`}>
					Peta Lokasi
				</h1>
				<iframe
					className="relative rounded-lg border-amber-300 border-2 w-full"
				...
				<p className={`${jkt.className} ${'text-white text-center'}`}>
					Jl. Kertamukti, Pisangan, Kec. Ciputat Timur., Kota Tangerang Selatan,
					Banten 15419
				</p>
				<button
					onClick={handleMarker}
					className="btn mt-5 bg-warning text-black border-none hover:bg-white">
